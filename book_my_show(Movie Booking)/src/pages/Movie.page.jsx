    ...
    <>
      ...
      <div className="my-12 container px-4 lg:ml-20 lg:w-2/3">
       ...
       {cast.map((castdata)=>(
        ...
        <div className="my-8">
         <PosterSlider congig={settings} title="Recommended Movies" RecomendedMovies={similarMovies} isDark={false}/>
        </div>
        ...
        <div className="my-8">
        <PosterSlider congig={settings} title="BMS XCLUSIVE" RecomendedMovies={recommended} isDark={false}/>
        </div>
      </div>
    </>
  )
